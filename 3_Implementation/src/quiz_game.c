/**
 * @file quiz_game.c
 * @author Shiva S - https://github.com/shiva-s30/265460-MiniProject/
 * @brief MiniProject - Tecquizz - Game of Quiz
 * @version 0.1
 * @date 2021-04-15
 * 
...
/**
 * @brief "header.h" contains all necessary 
 * header files required for the project
 * 
 */
...
/**
 * @brief Marking Scheme for Round 1
 * Increment of 10
 * @param s1 
 * @return int 
 */
...
/**
 * @brief Marking Scheme for Round 2
 * Increment of 5
 * @param s3 
 * @return int 
 */
    ...
    switch (index_p)
        {
          case 1:
                    ...
                    
                    {
                        ...
                        t_score = score_pos_r1(t_score);
                        getchar();
                    }
                    else
                    {
                        printf("Wrong Answer\n");
                        t_score = score_neg_r1(t_score);
                        getchar();
                    }
    ...
    switch (index_a)
        {
          case 1:
                    ...
                    {
                        printf("Correct Answer\n");
                        t_score = score_pos_r2(t_score);
                        getchar();
                    }
                    else
                    {
                        printf("Wrong Answer\n");
                        t_score = score_neg_r2(t_score);
                        getchar();
                    }
